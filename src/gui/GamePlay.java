...
import datatoplayer.Box;
import datatoplayer.GlobalBoard;
import datatoplayer.LocalBoard;
import datatoplayer.Player;
...
public class GamePlay extends javax.swing.JFrame {
    ...
    private void newMPGamePlay() throws Exception {
        ...
        this.player1 = new Player("player1", Config.player1Name, "X", 0, 1);
        this.player2 = new Player("player2", Config.player2Name, "O", 0, 0);
    ...
    private void publishPlayerNames() throws Exception {
        player1NameTF.setText(Config.player1Name);
        player2NameTF.setText(Config.player2Name);
    }
    ...
    private void initComponents() {
        ...
        box_11_Btn.setBackground(new java.awt.Color(255, 204, 204));
        ...
        nextTurnSignLbl.setFont(new java.awt.Font("Times New Roman", 1, 24)); // NOI18N
        nextTurnSignLbl.setForeground(new java.awt.Color(204, 0, 204));
        nextTurnSignLbl.setText("(X)");
        jPanel1.add(nextTurnSignLbl, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 140, -1, 40));

        nextTurnPlayerNameLbl.setFont(new java.awt.Font("Cantarell", 1, 20)); // NOI18N
        nextTurnPlayerNameLbl.setForeground(new java.awt.Color(204, 0, 204));
        nextTurnPlayerNameLbl.setText("Player 1");
        jPanel1.add(nextTurnPlayerNameLbl, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 150, -1, -1));
        ...
        player1ScoreTF.setBackground(new java.awt.Color(255, 255, 255));
        player1ScoreTF.setFont(new java.awt.Font("Times New Roman", 3, 18)); // NOI18N
        player1ScoreTF.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        player1ScoreTF.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                player1ScoreTFActionPerformed(evt);
            }
        });
        jPanel1.add(player1ScoreTF, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 390, 180, 40));

        player1NameTF.setEditable(false);
        player1NameTF.setBackground(new java.awt.Color(255, 255, 255));
        ...
        jPanel1.add(player1NameTF, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 80, 180, 40));
        ...
        player2NameTF.setBackground(new java.awt.Color(255, 255, 255));
        ...
        jPanel1.add(player2NameTF, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 80, 180, 40));
        ...
        jPanel1.add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(700, 330, -1, -1));

        player2ScoreTF.setEditable(false);
        player2ScoreTF.setBackground(new java.awt.Color(255, 255, 255));
        player2ScoreTF.setFont(new java.awt.Font("Times New Roman", 3, 18)); // NOI18N
        player2ScoreTF.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        player2ScoreTF.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                player2ScoreTFActionPerformed(evt);
            }
        });
        jPanel1.add(player2ScoreTF, new org.netbeans.lib.awtextra.AbsoluteConstraints(700, 380, 180, 40));
        ...
        jPanel1.add(homeBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 640, 130, 40));

        restartBtn.setFont(new java.awt.Font("Times New Roman", 3, 18)); // NOI18N
        ...
        jPanel1.add(restartBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 640, 120, 40));
        ...
        jPanel1.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 640, 130, 40));
...
private JFrame frame;
    ...
    private void player2ScoreTFActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_player2ScoreTFActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_player2ScoreTFActionPerformed

    private void player1ScoreTFActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_player1ScoreTFActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_player1ScoreTFActionPerformed
